...
<header class="title">
    ...
    <section>
      ...
      <form action="${pageContext.request.contextPath}/connect/kakao" method="POST">
       <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
				<input type="hidden" name="scope" value="" />
				<section class="main_section privacy">
          <header>
            <h3>개인정보 제3자 제공 동의</h3>
            <p>(주)카카오는 회원들의 개인정보를 안전하게 취급하는데 최선을 다합니다.</p>
          </header>
          <ul class="info_box">
            <li>
              <dl>
        ...
        <button id="acceptButton" type="submit" name="user_oauth_approval" value="true" class="btn btn_agree">동의
          </button>
        </div>
      </form>
    </section>
